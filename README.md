...
- `public/media/hero.mp4` — фон первого экрана, сгенерирован в Gemini (Veo) и склеен в бесшовную 9-секундную петлю без звука; `hero-poster.webp` — его первый кадр, виден, пока видео грузится.
- `public/media/showreel.webm` — зацикленный шоурил из этих скриншотов (16 с, VP8). Он играет в блоке со скролл-раскрытием и служит запасным видео для первого экрана, если основной ролик не воспроизведётся.
