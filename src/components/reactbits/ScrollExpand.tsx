      ...
      <div ref={trackRef} className="relative w-full">
        <div ref={stageRef} className="sticky top-0 w-full overflow-hidden [--se-title-size:4rem]">
          ...
          {title ? (
            <div
              ref={titleRef}
              className={`absolute inset-0 flex items-center justify-center m-0 px-[6%] text-center leading-none tracking-[-0.03em] text-white [font-size:var(--se-title-size)] [text-shadow:0_2px_24px_rgba(0,0,0,0.45)] pointer-events-none [will-change:opacity,transform] ${titleClassName}`}
            >
              {title}
            </div>
          ) : null}
